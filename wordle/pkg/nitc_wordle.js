...
export class WordleGame {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WordleGameFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
     ...
     */
    is_game_over() {
        const ret = wasm.wordlegame_is_game_over(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {boolean}
     */
    is_won() {
        const ret = wasm.wordlegame_is_won(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
    ...
    constructor(secret_word) {
        ...
        const ret = wasm.wordlegame_new(ptr0, len0);
        this.__wbg_ptr = ret;
        WordleGameFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @param {string} guess
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('nitc_wordle_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
